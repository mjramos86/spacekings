  ...
  const Combat = {
      ...
      return (
        `<div class="enemy-area">` +
          `<div class="enemy-stack">` +
            ...
            enemyBars +
            `<div class="enemy-sprite ${enemy.isBoss ? "boss" : enemy.isShip ? "ship" : ""}" id="cb-enemy">` +
    ...
    _attack(st, atk, def, side) {
      ...
      if (side === "player") {
        ...
        const sc = document.getElementById("run-scene"); // on-foot modes: fire the first-person blaster
